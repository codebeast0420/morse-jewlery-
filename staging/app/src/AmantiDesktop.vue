      ...
      <div class="basis-5/12 flex pr-1 py-4" style="display: flex; justify-content: center">
        ...
        <div class="basis-9/12 flex flex-col">
          ...
          <div class="flex flex-row mt-4" style="display: flex; justify-content: center">
            <!-- Amanti (Simple) Input-->
            <div v-show="$parent.optionActive == 'message'" :class="`basis-11/12`" v-if="$parent.classes.amanti.includes($parent.key) && $parent.key != 'aquafiore-bracelet' && $parent.key != 'aquafiore-pendant'">
            ...
            <!-- Select Metal-->
            <div v-show="$parent.optionActive == 'metal'" v-if="$parent.key == 'amanti'" :class="`flex flex-col basis-12/12 w-full`" style="display: flex; justify-content: center">
            ...
            <!-- Select Size-->
            <div v-show="$parent.optionActive == 'size'" v-if="$parent.key == 'amanti'" :class="`flex flex-col basis-12/12 w-full`" style="display: flex; justify-content: center">
