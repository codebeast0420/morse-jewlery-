<template>
  <div class="w-full">
    <div class="w-full" v-if="desktop">
      <amanti-desktop v-if="key == 'amanti'"></amanti-desktop>
      <mayfair-desktop v-if="key == 'mayfair'"></mayfair-desktop>
      <aquafiorebracelet-desktop v-if="key == 'aquafiore-bracelet'"></aquafiorebracelet-desktop>
  ...
  -->
    ...
    <!-- Mobile Version -->
    <div class="w-full" v-if="!desktop">
      <amanti-mobile v-if="key == 'amanti'"></amanti-mobile>
      <mayfair-mobile v-if="key == 'mayfair'"></mayfair-mobile>
    </div>
  </div>
</template>
<script>
import AmantiDesktop from "./AmantiDesktop.vue";
import AmantiMobile from "./AmantiMobile.vue";
import MayfairDesktop from "./MayfairDesktop.vue";
import MayfairMobile from "./MayfairMobile.vue";
import AquafiorebraceletDesktop from "./AquafiorebraceletDesktop.vue";
...
export default {
  components: { AmantiDesktop, AmantiMobile, MayfairDesktop, MayfairMobile, AquafiorebraceletDesktop, EffectComposer, HalftonePass, RenderPass, UnrealBloomPass },
  computed: {
    buyButtonDisabled() {
      let r = false;
