      ...
      >
        <div className="save-design">
          <div className="save-design__close">
            <Button className="save-design__close__button" onClick={onClose}>
              <Close />
            </Button>
          </div>
          <div className="save-design__content">
            <div className="save-design__content__wrapper">
              ...
              />
              <div className="save-design__content__max-chars">30 characters maximum</div>
              {(!saved && (
                <ClickableDiv
                ...
                >
                  <div className="save-design__content__button__content">
                    <div className="save-design__content__button__title">Save my design</div>
                    <div className="save-design__content__button__icon">{(saving && <FontAwesomeIcon icon={faCircleNotch} className="social-link" spin />) || <Bookmark />}</div>
                  </div>
                </ClickableDiv>
              )) || (
                <div className="save-design__content__success">
                  <div className="save-design__content__success__content">
                    ...
                    <div className="save-design__content__success__subtitle">
                      ...
                      <a href={`${URL}my-account/saved-designs/`} target="_blank" rel="noopener noreferrer">
                        your account
                      </a>
                    </div>
                  </div>
