...
import { faWhatsapp, faFacebookF, faTwitter, faPinterestP } from "@fortawesome/free-brands-svg-icons";
import { faEnvelope, faCircleNotch } from "@fortawesome/free-solid-svg-icons";
import imageCompression from "browser-image-compression";
import { Close, CopyLink } from "../../../assets";
import { client, URL } from "../../../library/env";
...
class ShareModal extends React.Component {
  ...
  onEntered() {
    this.response = {};
    const { product, configuration, productParts, imageFunc, preMadeProduct } = this.props;
    imageCompression
  ...
  handleClick = async (source) => {
    const { product, configuration, imageFunc, productParts, preMadeProduct } = this.props;
    await imageCompression
      .getFilefromDataUrl(imageFunc())
      .then(async (file) => {
        const options = {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="share">
          ...
          >
            <Close />
          </Button><div className="share__title">Share this design</div>
   ...
   <ClickableDiv
              ...
              <ClickableDiv
                ...
                disabled={spin}>
                <div className="share__content__method__icon"><FontAwesomeIcon icon={spin ? faCircleNotch : faTwitter} className="social-link" spin={spin} /></div>
            ...
            <div className="share__content__wrapper">
              <ClickableDiv
                ...
                disabled={spin}
              >
                <div className="share__content__method__icon">{(spin && <FontAwesomeIcon icon={faCircleNotch} className="social-link" spin />) || <CopyLink />}</div>
