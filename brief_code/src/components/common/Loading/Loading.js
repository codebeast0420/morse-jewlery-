...
class Loading extends React.PureComponent {
  constructor(props) {
    ...
    this.children = Children.deepMap(children, (child) => React.cloneElement(child, { ...child.props, showLoading: this.state.showLoading, key: Math.random(1000) }));
  }
...
Loading.propTypes = {
  children: PropTypes.oneOfType([PropTypes.instanceOf(Object), PropTypes.instanceOf(Array)]).isRequired,
};
