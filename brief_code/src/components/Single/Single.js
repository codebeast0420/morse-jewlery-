...
import MorseCode from "../../library/morse_code";
...
class Single extends React.Component {
  ...
  constructor(props) {
    ...
    if (product.data.id !== 2096 && product.data.id !== 2124) {
      ...
      if (product.data.id === 186) {
        _.each(letters, (letter) => rings.push(`../assets/jewerly/rings_amanti/ring_${letter.toUpperCase()}.glb`));
      }
      if (product.data.id === 185) {
        _.each(letters, (letter) => rings.push(`../assets/jewerly/rings_mayfair/ring_mayfair_${letter.toUpperCase()}.glb`));
      }
      if (product.data.id !== 186 && product.data.id !== 185) {
        for (let i = 0; i < 26; i++) {
          // C5R
          rings.push(this.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_Chain_element.glb"));
        }
      }
      let jewerly = "";
      ...
      this.state = {
        ...
        stoneColorMessage: [],
        chainLength: product.data.id === 408 ? configuration.pa_hook_type_earrings.id : parseInt(configuration.pa_size.name, 10),
  ...
  componentDidMount() {
    ...
    if (product.data.id !== 186 && product.data.id !== 185 && product.data.id !== 2096 && product.data.id !== 2124) {
        ...
        items: [
          {
            ...
            price: Pricing.priceCalc(product.data.id, productParts.data, configuration).price,
            quantity: 1,
          },
        ],
      },
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.configuration.pa_material.color !== configuration.pa_material.color) {
      this.setState({ ringColor: configuration.pa_material.color });
    }
    if (prevProps.configuration.pa_size.id !== configuration.pa_size.id) {
      if (product.data.id !== 186 && product.data.id !== 185 && product.data.id !== 2096) {
        this.setState({ chainLength: parseInt(configuration.pa_size.name, 10) }, () => {
          this.create_chain(configuration.message);
        });
      }
      if (product.data.id === 2096 || product.data.id === 2124) {
    ...
    if (product.data.id === 408 && prevProps.configuration.pa_hook_type_earrings.id !== configuration.pa_hook_type_earrings.id) {
      this.setState({ chainLength: configuration.pa_hook_type_earrings.id }, () => {
        this.create_chain(configuration.message);
      });
    }
    if (!_.isEqual(configuration.pa_stone, prevProps.configuration.pa_stone) && product.data.id !== 186 && product.data.id !== 185 && product.data.id !== 2096 && product.data.id !== 2124) {
      if (configuration.pa_stone.id === "solid_color") {
        this.handleOverrideAllMorseCharColors(configuration.pa_stone.choice[0].value.color);
      }
    }
    if (prevProps.configuration.message === this.props.configuration.message && product.data.id !== 186 && product.data.id !== 185 && product.data.id !== 2096 && product.data.id !== 2124) {
      if (configuration.pa_stone.id === "at_your_choice" || configuration.pa_stone.id === "themes") {
        const items = [];
        ...
        if (configuration.pa_stone.id === "at_your_choice") {
          this.handleMorseCharColorChange(configuration.pa_stone.choice[configuration.pa_stone.slide].value.color, items[configuration.pa_stone.slide]);
        }
  ...
  create_NECKLACE(message) {
    ...
    function addChainElement(urlsArray, f) {
      ...
      urlsArray[f](
        self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_Chain_element.glb", {
    ...
    message.split(" ").forEach((msg) => {
      ...
      ringsUrlsArray.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_HX.glb")); // code logo
      ...
      msg.split("").forEach((char, i) => {
        ...
        if (msg.length - 1 !== i) {
          ringsUrlsArray.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_SP.glb")); // SP
    ...
    ringsUrlsArray.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_HX.glb")); // empty code logo - terminator

    totalLengthInCm += self.getChainElementSize("Aquafiore_HX");

    // then add chain elements to the beginning and to the end

    const selectedChainLength = this.units_to_cm_coef * parseFloat(self.state.chainLength) || 42;

    const lastChainLength = (selectedChainLength - totalLengthInCm) / 2;

    let chainElementsCount1 = (lastChainLength - self.getChainElementSize("Aquafiore_JR")) / self.getChainElementSize("Aquafiore_Chain_element");

    let chainElementsCount2 = (lastChainLength - self.getChainElementSize("Aquafiore_CL")) / self.getChainElementSize("Aquafiore_Chain_element");
    ...
    let l1 = self.getChainElementSize("Aquafiore_Chain_element") * chainElementsCount1;
    ...
    chainElementsCount1 = chainElementsCount1 % 2 === 0 ? chainElementsCount1 : chainElementsCount1 + 1;
    ...
    ringsUrlsArray.unshift(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_JR.glb"));
    ...
    let l2 = self.getChainElementSize("Aquafiore_Chain_element") * chainElementsCount2;
    ...
    chainElementsCount2 = chainElementsCount2 % 2 === 0 ? chainElementsCount2 + 1 : chainElementsCount2;
    ...
    ringsUrlsArray.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_CL.glb")); //
  ...
  create_BRACELET(message) {
    ...
    const bracelet_letter = self.validate_msg(message).split("").slice(0, 1).join(""); // 1 letters
    ...
    const selectedChainLength = this.units_to_cm_coef * parseFloat(self.state.chainLength) || 17;

    // --> add elements to the beginning

    const lastChainLength = (selectedChainLength - totalLengthInCm) / 2;

    let chainElementsCount = (lastChainLength - self.getChainElementSize("Aquafiore_JR") - self.getChainElementSize("Aquafiore_JR")) / self.getChainElementSize("Aquafiore_Chain_element");
    ...
    ringsUrlsArray.unshift(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_JR.glb", null));
    ...
    chainElementsCount = (lastChainLength - self.getChainElementSize("Aquafiore_CL")) / self.getChainElementSize("Aquafiore_Chain_element");
  ...
  create_PENDANT(message) {
    ...
    links_array_3.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_JR.glb"));
    ...
    msg.split("").forEach((char, i) => {
      ...
      lCodeArray.forEach((value, j) => {
        if (value === "dot") {
          const item = j === 0 ? self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_RDJR.glb") : self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_RD.glb");
          ...
          const item = j === 0 ? self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_OBJR.glb") : self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_OB.glb");
    ...
    links_array_1.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_JR.glb"));
    ...
    chainElementsCount = Math.floor(chainElementsCount);
    chainElementsCount = chainElementsCount > 5 ? chainElementsCount : 5;
    chainElementsCount = chainElementsCount % 2 === 0 ? chainElementsCount - C5R + 1 : chainElementsCount - C5R;

    links_array_2.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_JR.glb"));
    ...
    links_array_2.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_HX.glb")); // refer pdf
    ...
    links_array_2.push(self.create_link("../assets/jewerly/ringsAquafiore/Aquafiore_CL.glb"));
  ...
  applyStoneColor(gltf, color) {
    ...
    gltf.diamondUniformOverrides.colorCorrection = renderer.getColorAsVector(values.colorCorrection);
    gltf.diamondUniformOverrides.boostFactors = renderer.getColorAsVector(values.boostFactors);
    gltf.diamondUniformOverrides.Absorbption = renderer.getColorAsVector(values.Absorbption);
      ...
      if (product.data.id !== 186 && product.data.id !== 185) {
        ...
        if (configuration.pa_stone.id === "at_your_choice" || configuration.pa_stone.id === "themes") {
          ...
          _.each(items, (item, index) => {
            this.handleMorseCharColorChange(configuration.pa_stone.choice[index].value.color, item);
          });
        }
      }
    } else {
  ...
  modals = () => {
    ...
    //const gallery = () => <GalleryModal open={galleryModal} onClose={() => this.setState({ galleryModal: false })} />;
      ...
      return (
        <div className="morse-code__single__letter" key={Math.random() * 1000}>
          {l
            ...
            .reverse()
            .map((code) => (
              <div className={`morse-code__single--${code}`} key={Math.random() * 1000} />
            ))}
        </div>
      );*/
    });
  ...
  render() {
    const { ringsUrls, stoneColor, ringColor, height, load, createChainType, chainLength, showInfos } = this.state;
        ...
        <div className="single" style={{ height }}>
          <div className="single__threejs">
            <div className={`info-message ${showInfos ? "show" : "hide"}`}>
              <div className="morse-code__single">{this.buildMorseCode(configuration.message)}</div>
              <div
            ...
            {load && <JewerlyRingsRenderer ringsUrls={ringsUrls} stoneColor={stoneColor} ringColor={ringColor} onBeforeLoad={this.handleOnRingOnBeforeLoad} onLoad={this.handleOnRingOnLoad} onReadyToUse={this.handleOnReadyToUse} onInteraction={this.handleOnInteraction} />}
            <div className={`view-gallery ${showInfos ? "show" : "hide"}`}>
              <img src={icon360} alt="" />
            </div>
            <ClickableDiv className={`view-gallery ${showInfos ? "hide" : "show"}`} onClick={() => this.setState({ galleryModal: true })}>
              <div>View Gallery</div>
            </ClickableDiv>
          </div>
          <SingleMenu finishAnime={() => this.setState({ load: true })} showLoading={showLoading} product={product.data} />
          {this.modals()}
        </div>
      );
      */
    ...
    return (
      <div className="single" style={{ height }}>
        <div className="single__threejs">
          ...
          {load && <JewerlyRingsRenderer ringsUrls={ringsUrls} stoneColor={stoneColor} ringColor={ringColor} createChainType={createChainType} chainElementsNames={chainElementsNames} chainLength={chainLength} onReadyToUse={this.handleOnReadyToUse} onBeforeLoad={this.handleOnRingOnBeforeLoad} onLoad={this.handleOnRingOnLoad} onInteraction={this.handleOnInteraction} />}
          <div className={`view-gallery ${showInfos ? "show" : "hide"}`}>
            <img src={icon360} alt="" />
          </div>
          <ClickableDiv className={`view-gallery ${showInfos ? "hide" : "show"}`} onClick={() => this.setState({ galleryModal: true })}>
